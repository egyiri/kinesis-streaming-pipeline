...
dest_group.add_argument(
    "--dest_streams_file",
    type=str,
    help="Path to a JSON file with only two keys: 'USA' and 'International'.",
)
...
def main():
    ...
    if args.dest_streams_file:
        with open(args.dest_streams_file, "r") as f:
            kinesis_dest_stream_names = json.load(f)
    else:
